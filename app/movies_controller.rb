...
def can_be_created_in_a_block(arg={title: "Home Alone", release_date: 1990, director: nil, lead: nil, in_theaters: nil})
  # If no arguments are passed, use default values:
  # title == "Home Alone"
  # release_date == 1990
  Movie.create(arg)
  # Movie.create do |m|
  #   movie = Movie.new(title: "Home Alone", release_date: 1990, director:, lead:, in_theaters: )
  #   movie.save
  # end
end
...
def can_update_using_update_method
  ...
  Movie.where(title: "Wat?").update(title:
  "Wat, huh?")
end
